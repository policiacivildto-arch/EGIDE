              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    {formData.departamento && departamentos.find(d => d.id === parseInt(formData.departamento))?.sigla && DEPARTMENTS[departamentos.find(d => d.id === parseInt(formData.departamento)).sigla] ? 
                      DEPARTMENTS[departamentos.find(d => d.id === parseInt(formData.departamento)).sigla].map(delegacia => (
