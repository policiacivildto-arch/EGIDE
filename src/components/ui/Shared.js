...
export const Modal = ({ children, onClose, size = '3xl', contentClassName = '' }) => {
    const sizeClasses = {
        '3xl': 'max-w-3xl',
        '5xl': 'max-w-5xl',
    };
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4">
            <div className={`bg-gray-100 rounded-2xl shadow-2xl w-full ${sizeClasses[size] || 'max-w-3xl'} max-h-[90vh] overflow-y-auto p-8 relative animate-fade-in-up ${contentClassName}`}>
