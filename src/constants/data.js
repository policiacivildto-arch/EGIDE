...
export const AIS_BAIRROS = {
    ...
    "14": ["Conj. Jereissati I", "Conj. Jereissati II (até a rua 64)", "Serra do Maracanaú", "Santo Antônio do Pitaguary", "Loteamento Maracanaú Sul", "Olho d'Água de Cima", "Olho d'Água de Baixo", "Olho d'Água dos Pratas", "Estrada da Tangueira", "Furna da Onça", "Aterro Sanitário", "Mutirão Vida Nova", "Colônia Antônio Justa", "Fórum do Maracanaú", "Olaria", "Horto", "Escola de Menores", "Picadas", "Residenciais São Francisco", "Santa Marta", "Bela Vista", "Jardim do Amor", "Alto da Mangueira", "Boa Vista", "Coqueiral", "Centro", "Piratininga (até a rua Peru)", "Conjunto Industrial", "Esplanada Mondubim e parte do Aracapé", "Acaracuzinho", "Jaçanaú", "Parque Jari", "Parque Tijuca", "Alto Alegre I", "Alto Alegre II", "Santo Sátiro", "Novo Oriente", "Siqueira", "Conjunto Timbó", "Distrito Industrial I e II", "Cágado", "Mucunã", "Parque Luzardo Viana", "Pau Serrado", "Residencial Maracanaú", "Piratininga", "Novo Maracanaú", "Jenipapeiro", "Maracananzinho", "Pajuçara", "Jardim Bandeirantes", "Boa Esperança", "Planalto Cidade Nova", "Distrito Industrial III"],
